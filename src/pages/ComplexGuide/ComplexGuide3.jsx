  ...
  return (
    <div className={styles.container}>
      <Helmet>
        ...
        <meta
          name="description"
          content="아산 모종 서한이다음의 커뮤니티 시설을 소개합니다. 피트니스센터, 실내 골프연습장, 작은도서관(북카페), 주민 라운지 등 입주민의 생활 품격을 높이는 다양한 편의시설을 만나보세요."
        />
        ...
        <meta
          ...
          content="피트니스·실내골프·작은도서관·라운지 등 다양한 커뮤니티로 일상의 가치를 높이는 아산 모종 서한이다음."
        />
