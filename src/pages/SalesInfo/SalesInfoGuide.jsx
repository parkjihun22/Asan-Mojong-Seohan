...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
        <Helmet>
          <title>아산 모종 서한이다음 - 청약안내</title>
          <meta
            name="description"
            content="아산 모종 서한이다음 청약안내를 한눈에 확인하세요. 특별공급·1·2순위 청약 일정, 자격요건, 필요서류와 인터넷 청약 절차를 안내합니다."
          />
        ...
        <p className={styles.screenReaderOnly}>
          아산 모종 서한이다음의 인터넷 청약은 간편하고 신속하게 참여할 수 있는 방법입니다.
        ...
        <div className={styles.textBox}>
          ...
          <div>아산 모종 서한이다음, 기회를 놓치지 마세요</div>
        </div>
