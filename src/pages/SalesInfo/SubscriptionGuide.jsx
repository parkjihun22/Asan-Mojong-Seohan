...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
      <Helmet>
        <title>아산 모종 서한이다음 - 체크포인트</title>
        <meta
          name="description"
          content="아산 모종 서한이다음 분양 전 필수 체크포인트를 확인하세요. 청약 자격(거주기간·무주택·예치금), 특별공급 유형, 필요서류·일정, 유의사항을 한눈에 안내합니다."
        />
        <link rel="canonical" href="https://www.kf-liria.com/SalesInfo/SubscriptionGuide" />
      ...
      <p className={styles.screenReaderOnly}>
        아산 모종 서한이다음 분양 전 확인해야 할 핵심 체크리스트입니다.
      ...
      <div className={styles.textBox}>
        ...
        <div>아산 모종 서한이다음, 분양 전 체크포인트를 확인하세요.</div>
      </div>
