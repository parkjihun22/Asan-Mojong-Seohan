        ...
        <>
          ...
          <div className={styles.section}>
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                - KTX 천안아산역·서해선 복선전철(예정) 수도권 접근성 우수<br />
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="아산 모종 서한이다음브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>아산 모종 서한이다음</div>
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="아산 모종 서한이다음오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.imageContainer}>
            <img
              src={mobileImageMain}
              className={styles.mainImage}
              alt="아산 모종 서한이다음mobilemain-image1"
            />
            <div className={styles.overlay}></div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 아산 모종 서한이다음에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="아산 모종 서한이다음모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="아산 모종 서한이다음브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="아산 모종 서한이다음오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
