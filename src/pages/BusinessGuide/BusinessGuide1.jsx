...
const projectData = [
	{ label: '사업명', value: '아산 모종 서한이다음' },
	{ label: '사업위치', value: '인천광역시 아산군 선원면 창리 501번지 일원' },
...
const BusinessGuide1 = () => {
	...
	return (
		<div className={styles.container}>
				...
				<meta
					name="description"
					content="인천 아산군 선원면 창리 501번지 일원에 들어서는 아산 모종 서한이다음의 사업 개요를 확인하세요. 총 1,325세대(지하 2층~지상 25층, 21개동), 전용 59·72·84㎡ 구성, 입지·규모·입주(예정) 정보 안내."
				/>
				...
				<meta
					...
					content="아산읍 중심 생활권, 총 1,325세대의 브랜드 대단지. 위치·규모·타입 구성과 입주(예정) 정보를 한눈에 확인하세요."
				/>
				...
				<meta
					...
					content="아산 모종 서한이다음 사업 개요: 총 1,325세대, 전용 59·72·84㎡ 구성, 아산 중심 입지와 규모·일정 안내."
				/>
				...
				<script type="application/ld+json">
					...
					"description":
						"인천 아산군 선원면 창리 501번지 일원에 들어서는 아산 모종 서한이다음의 사업 개요와 위치, 규모, 타입 구성, 입주(예정) 정보를 제공합니다.",
					"primaryImageOfPage": {
						"@type": "ImageObject",
				...
				아산 모종 서한이다음는 아산읍 중심 생활권에 조성되는 브랜드 대단지입니다.
				...
				<div>아산 모종 서한이다음, 자부심으로 찾아옵니다.</div>
				</div>
