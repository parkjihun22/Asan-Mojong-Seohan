...
const Brand1 = () => {
    ...
    return (
        <div className={styles.container}>
            ...
            <meta
                name="description"
                content="두산건설 위브(WE’VE)의 브랜드 철학과 가치를 소개합니다. 품질 기준과 첨단 시공, 커뮤니티·서비스로 생활의 품격을 높이는 아산 모종 서한이다음."
            />
            ...
            <meta
                ...
                content="두산건설 위브(WE’VE) 브랜드 소개: 고객 중심 설계와 신뢰의 품질, 프리미엄 주거문화를 제시하는 아산 모종 서한이다음."
            />
            ...
            아산 모종 서한이다음는 신뢰와 품질을 최우선으로 하는 두산건설의 위브(WE’VE) 브랜드를 적용했습니다.
